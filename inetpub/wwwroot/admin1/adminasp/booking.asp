    ...
    <div class="body">
        ...
        <div class="section2">
            <h2 class="h2_1">Manage Booking</h2>
             ...
             Add New Booking</a>
             <a href="../adminhtml/removebook.html" class="add">
             Remove Booking</a>
             <a href="../adminhtml/findbooking.html" class="add">
...
%>
<tr>    
<td class="td_1" align="center"><% response.write(rs("first")) %></td>
<td class="td_1" align="center"><% response.write(rs("last")) %></td>
<td class="td_1" align="center"><% response.write(rs("maill")) %></td>
<td class="td_1" align="center"><% response.write(rs("dedate")) %></td>
<td class="td_1" align="center"><% response.write(rs("aedate")) %></td>
