    ...
    <div class="prt1">
      ...
      <nav class="main_nav">
        ...
        <div class="navigation_menu">
          <ul class="nav_ul1">
            <a href="../html/index.html" class="nav_a1">Home</a></li>
            ...
            <li class="nav_li"><a href="#" class="nav_a1">About Us</a></li>
        ...
        <tr class="tr_2">
            ...
            <td class="td_1" align="center"><% response.write(d) %></td>
            <td class="td_1" align="center"><% response.write(e) %></td>
            <td class="td_1" align="center"><% response.write(f) %></td>
        </tr>
    </table>
  </div>
