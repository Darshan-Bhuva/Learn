        ...
        <div class="prt1">
            ...
            <nav class="main_nav">
                ...
                <div class="navigation_menu">
                    <ul class="nav_ul1">
                        <li class="nav_li"><a href="../html/index.html" class="nav_a1">Home</a></li>
            ...
            <div class="prt3">
                ...
                <div class="prt3_1">
                  ...
                  <p>It's all about the humans behind a brand and those <br>
                ...
                <div class="prt3_2">
                    ...
                    <form action="../asp/contact.asp" method="post">
                        ...
                        <input type="text" name="work" placeholder="Your Profession" class="ip_2">
                        <br><br>

                        <textarea name="msg" placeholder="Enter Your Message...." class="ip_3"></textarea>
                        <br><br>
